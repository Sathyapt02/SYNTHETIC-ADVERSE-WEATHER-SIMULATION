...
data = np.loadtxt("Performance/TT.txt")
...
plt.ylabel("Training Time (sec)", fontsize=13, fontweight='bold')
plt.title("Training Time Comparison for Different Sample Sizes",
